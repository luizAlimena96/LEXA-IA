                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            ...
                            <p className={cn("text-xl md:text-2xl mb-8", textMuted)}>
                                Em breve, ofereceremos consultoria comercial especializada para escritórios de advocacia que desejam estruturar e otimizar seus processos de vendas.
                            </p>

                            <p className={cn("text-lg mb-12", textMuted)}>
                                Estamos preparando uma solução completa para ajudar seu escritório a alcançar novos patamares de conversão e eficiência comercial.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <a
                                    href="https://wa.me/5541988037508?text=Olá!%20Tenho%20interesse%20em%20saber%20mais%20sobre%20a%20Consultoria%20Comercial"
                                    target="_blank"
