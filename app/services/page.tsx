...
import { Moon, Sun, ArrowLeft, Briefcase } from 'lucide-react';
    ...
    return (
        <div className={cn("min-h-screen font-sans selection:bg-indigo-500/30", bgMain, textMain)}>
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
                ...
                <div className={cn("absolute bottom-[-20%] left-[50%] -translate-x-1/2 w-[1000px] h-[1000px] rounded-full blur-[120px] opacity-20", isDark ? "bg-indigo-900" : "bg-indigo-300")} />
            </div>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        >
                            ...
                            <p className={cn("text-xl md:text-2xl mb-8", textMuted)}>
                                Em breve, ofereceremos uma gama completa de serviços especializados para escritórios de advocacia.
                            </p>

                            <p className={cn("text-lg mb-12", textMuted)}>
                                Soluções integradas para transformar completamente a operação comercial do seu escritório.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <a
                                    href="https://wa.me/5541988037508?text=Olá!%20Tenho%20interesse%20em%20saber%20mais%20sobre%20a%20Lexa%20Services"
                                    target="_blank"
