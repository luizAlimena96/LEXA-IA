    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900">Estados (FSM)</h2>
                            ...
                            >
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-start gap-4 flex-1">
                                        <div className="flex items-center justify-center w-10 h-10 bg-indigo-100 text-indigo-600 rounded-lg font-bold text-lg">
                                            {index + 1}
                                        </div>
                                                ...
                                                <div className="mt-3 space-y-2">
                                                    {routes?.rota_de_sucesso?.map((route: any, idx: number) => (
                                                        <div key={idx} className="flex items-center gap-2 text-xs text-gray-600">
                                                            ...
                                                            <span className="text-gray-500">- {route.descricao}</span>
                                                        </div>
                                                    ))}
